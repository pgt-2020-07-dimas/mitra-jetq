                        ...
                        <div class="row mb-2 row-button" style="display: none;">
                            <div class="col">
                                <form action="/transaction/payment" method="post">
                                    @csrf
                                    @method('put')                                                
                                    <input type="hidden" class="clicked" name="invoice_id">
                                    <input type="hidden" name="status" value ="Pay">
                                    <input type="hidden" value="1" name="payment">
                                    <button class="btn btn-outline-primary btn-block"><span class="fas fa-check-square"></span> Confirm</button>
                                </form>  
                            </div>
                            <div class="col">
                                <form action="/transaction/payment" method="post">
                                    ...
                                    <button class="btn btn-outline-danger btn-block"><span class="fas fa-exclamation-circle"></span> Reject</button>
                                </form>  
                            </div>
                            <div class="col">
                                <a href="#" class="btn btn-outline-warning btn-block btn-edit" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo"><span class="fas fa-pen-square"></span> Edit</a>
                            </div>
                        </div>
                        <!-- END ROW 7 -->
                    </div>
